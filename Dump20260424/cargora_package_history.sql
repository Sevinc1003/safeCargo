...
CREATE TABLE `package_history` (
  ...
  `status` enum('ARRIVED','AT_FOREIGN_WAREHOUSE','DECLARATION','DECLARED','DELIVERED','ON_THE_WAY') NOT NULL,
  `timestamp` datetime(6) NOT NULL,
  `package_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK3wl5e1yj3orjg3i5mbhsulrk1` (`package_id`),
  CONSTRAINT `FK3wl5e1yj3orjg3i5mbhsulrk1` FOREIGN KEY (`package_id`) REFERENCES `packages` (`id`)
